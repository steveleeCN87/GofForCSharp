...
using DesignPattern.Prototype.ConcretePrototype;
using DesignPattern.Prototype.PrototypeManager;
...
namespace DesignPattern.Prototype
{
    public class Program
    {
        ...
        {
            PrototypeManager.PrototypeManager pm = PrototypeManager.PrototypeManager.GetInstance();
